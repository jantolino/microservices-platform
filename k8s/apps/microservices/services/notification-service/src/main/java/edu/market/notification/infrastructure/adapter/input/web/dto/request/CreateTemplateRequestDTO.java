...
/**
 * DTO para recibir solicitudes de creación de plantillas de notificación a través de la API REST.
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request to create a new notification template")
public class CreateTemplateRequestDTO {
    ...
    @Schema(description = "Additional metadata for the template", 
            example = "{\"version\": \"1.0\", \"category\": \"welcome\"}")
