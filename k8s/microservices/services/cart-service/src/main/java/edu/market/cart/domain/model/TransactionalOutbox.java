...
import edu.market.cart.domain.exception.OutboxException;
...
public class TransactionalOutbox {
    ...
    private TransactionalOutbox(UUID id, EventStatusType statusType, String aggregateId, String payload, 
                       LocalDateTime createdAt, boolean processed, LocalDateTime processedAt,
                        int retryCount, String message, LocalDateTime lastRetryAt, CartEventType eventType) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public Builder withEventType(CartEventType eventType) {
            this.eventType = eventType;
            return this;
        }
