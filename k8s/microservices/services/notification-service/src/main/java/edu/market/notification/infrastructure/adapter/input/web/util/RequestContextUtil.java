package edu.market.notification.infrastructure.adapter.input.web.util;
...
public class RequestContextUtil {
    ...
    public ClientContextCommand getClientContext(String requesterId) {
     
        return new ClientContextCommand(
